...
describe("createPlayer", () => {
  ...
  it("carries an accountId through when one is given", () => {
    expect(
      createPlayer({ id: "a", name: "Dave", accountId: "acct-1" }),
    ).toEqual({
      id: "a",
      name: "Dave",
      accountId: "acct-1",
...
describe("validateGameResult", () => {
  ...
  it.each([
    ...
    [
      {
        playerIds: ["a", "b"],
        placings: [{ playerId: "a", place: Number.NaN }],
      },
      "place-out-of-range",
    ],
